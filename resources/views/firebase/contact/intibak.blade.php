...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card" id="pdfindirme">
                   ...
                   <p>Fakültesi <input type="text" style="border: none">  Bölümüne İntibak</p>
                   <p>başvurusu yapmak istiyorum. Aşağıda doldurduğum bilgilerin doğruluğunu taahhüt ederim. Başvuru için gerekli</p>
                    ...
                    <br><br><br>
                    <p>Ders:<input type="text" style="border: none"> </p>
                    <p>Not:<input type="text" style="border: none"> </p>
                    <p>Akts: <input type="text" style="border: none"> </p>
                    <br>
                    <p>Ders:<input type="text" style="border: none"> </p>
                    <p>Not:<input type="text" style="border: none"> </p>
                    <p>Akts: <input type="text" style="border: none"> </p>
                   ...
                   <p>Öğrenci Fakülte:  <input type="text" style="border: none"> </p>
                   <p>Öğrenci Bölüm:  <input type="text" style="border: none"> </p>
    ...
    document.getElementById("indir")
        .addEventListener("click", () => {
            ...
            var opt = {
                margin: 1,
                filename: 'İntibak Başvurusu.pdf',
