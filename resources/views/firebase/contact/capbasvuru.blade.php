        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card" id="pdfindirme">
                   ...
                   <p>Fakültesi <input type="text" style="border: none">  Bölümüne Çift Anadal</p>
                   <p>başvurusu yapmak istiyorum. Aşağıda doldurduğum bilgilerin doğruluğunu taahhüt ederim. Başvuru için gerekli</p>
                    ...
                    <p>Not:</p>
                    <p>Öğrencinin AGNO’su en az 3.00 olmalıdır.</p>
                    <p>Öğrenicinin başarısız (F) dersi olmamalıdır.</p>
                    <p>Öğrenci en erken 3. yarıyıl en geç 5. yarıyılda kayıtlıolmalıdır.</p>
