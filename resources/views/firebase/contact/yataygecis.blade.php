...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card" id="pdfindirme">
                   ...
                   <p>Fakültesi <input type="text" style="border: none">  Bölümüne yatay geçiş</p>
                   ...
                   <p> Adres: </p> <input type="text" style="border: none"> </p>                                  
                   ...
                   <p>Öğrenci AGNO:  <input type="text" style="border: none"> </p>                 
                   <br>
                   <br>
                   <br>
                   <br>
    ...
    document.getElementById("indir")
        .addEventListener("click", () => {
            ...
            var opt = {
                margin: 1,
                filename: 'Yatay Geçiş Başvurusu.pdf',
