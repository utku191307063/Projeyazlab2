...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card" id="pdfindirme">
                   ...
                   <p>Sınavı ile yerleştirildim. Daha önce bitirmiş olduğum okuldaki transkriptim ve ders içerikleri ekte sunulmuştur.</p>
                   <p>Gerekli ders muafiyetimin ve sınıf intibakımın yapılabilmesi için gereğini arz ederim. </p>
    ...
    document.getElementById("indir")
        .addEventListener("click", () => {
            ...
            var opt = {
                margin: 1,
                filename: 'Yaz Okulu Başvurusu.pdf',
