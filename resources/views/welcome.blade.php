  ...
  display: inline-block;
      ...
      <body>
        ...
        <br>
            ...
            <h2 style="color: #0e311f ; margin-left:550px ; font-size:50px; text-align:center " >Kocaeli Üniversitesi</h2>
                        ...
                        <div class="login" style="margin-left: 650px;">    
                          ...
                          @endif 
                           ...
                           <br>
                            <a href={{url('yenikayıt')}} style="color: inherit;">Yeni Kayıt</a>         
                              &nbsp;  &nbsp;   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                             <a href={{url('sifremiunuttum')}} style="color: inherit;">Şifremi Unuttum</a> 
                             <br> 
                            <br>
                            <br>
                              ...
                              <br>
                              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <button>
                                <a href={{url('admin')}} style="color: inherit; text-decoration: none;">Admin Girişi</a>
                              </button> 
                                  </div>
                            </form>     
                        </div>
